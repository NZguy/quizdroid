...
public class DataRepository{
    ...
    public void initializeData() {
        ...
        topics.add(new Topic("Math", "descShort", "descLong"));
        topics.add(new Topic("Physics", "descShort", "descLong"));
        ...
        topics.get(0).addQuestion(new Question("question", questions2, 2));
    }
